          ...
          >
            ...
            <div className="relative">
              <div className="aspect-video bg-gradient-to-br from-blue-500 to-purple-600 relative overflow-hidden">
                {video.youtubeUrl ? (
                  <img 
                    src={getYouTubeThumbnail(video.youtubeUrl) || video.thumbnail} 
                    alt={video.title}
                    className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300"
                    onError={(e) => {
                      // Fallback to default thumbnail if YouTube thumbnail fails
                      const target = e.target as HTMLImageElement
                      target.src = video.thumbnail || 'https://via.placeholder.com/400x225/1f2937/ffffff?text=Video'
                    }}
                  />
                ) : video.thumbnail ? (
                  <img 
                ...
                <div className="flex items-center space-x-2">
                  <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center">
                    <span className="text-white text-xs font-bold">
                      {video.channelTitle.split(' ').map(n => n[0]).join('')}
                    </span>
                  </div>
                  <div>
                    <p className="text-white text-sm font-medium">{video.channelTitle}</p>
                    <p className="text-gray-400 text-xs">YouTube Channel</p>
                  </div>
                </div>
              ...
              <div className="flex space-x-2">
                ...
                <Button 
                  ...
                  onClick={(e) => {
                    ...
                    navigator.share?.({
                      title: video.title,
                      text: `Check out this amazing football video by ${video.channelTitle}!`,
