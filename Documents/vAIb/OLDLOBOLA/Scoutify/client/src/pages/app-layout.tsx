...
export default function AppLayout() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-purple-900">
      {/* Navigation */}
      <nav className="bg-white/10 backdrop-blur-sm/10 backdrop-blur-sm border-b border-white/20">
              ...
              <CardContent className="pt-6">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-300">Midfielder, Kaizer Chiefs Academy</p>
                  </div>
                </div>
                <p className="text-gray-700">
                  "Scoutlify helped me get noticed by scouts when I was just 16. 
              ...
              <CardContent className="pt-6">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-300">Forward, Orlando Pirates Development</p>
                  </div>
                </div>
                <p className="text-gray-700">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-green-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link href="/auth">
            <Button size="lg" variant="secondary" className="bg-white/10 backdrop-blur-sm text-white hover:bg-gray-100">
              Create Your Profile
              <ArrowRight className="ml-2 h-4 w-4" />
            </Button>
          </Link>
      ...
      <footer className="bg-gradient-to-br from-slate-900 to-slate-800 text-white py-12 px-4 sm:px-6 lg:px-8 border-t border-slate-700">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-lg font-semibold mb-4 text-glow">Scoutlify</h3>
          ...
          <div className="border-t border-slate-700 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2024 Scoutlify. Level up your game! 🚀⚽</p>
          </div>
        </div>
      </footer>
